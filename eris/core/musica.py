...
class _ViewControlesMusica(discord.ui.View):
    ...
    async def _feedback(self, interaction, valor, resposta):
        # 🔥 Só a faixa EXATA, nunca o artista inteiro (2026-08-27, pedido
        # do usuário: "um 👎 em 1 musica n pode condenar todas desse
        # artista. Assim como o like n aprova todas tbm, algumas eu gosto e
        # outras nao") - reverte a limpeza da fila lógica por artista
        # adicionada mais cedo hoje (o ECHO também parou de invalidar o
        # artista inteiro no pool dele, mesmo motivo - ver `pool.py`/
        # `feedback.py` do Project-ECHO).
